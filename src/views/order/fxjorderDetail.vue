    ...
    <div class="salecustomercontent contaner">
      ...
      <div class="content">
        <div class="contanternews">
          ...
          <div class="dataGeneral backWhite padding20">
            ...
            <div class="orderInfo flex">
              <div class="infoLeft">
                ...
                <div v-if="redeemCode" class="infoBox">
                  <span class="colorGrey font12 marginright10">使用兑换码</span>
                  <span class="colorblack font12">{{redeemCode.redeemCode}}</span>
                </div>
              </div>
              <div class="infoRight" v-if="(orderDetail.payTime)">
                ...
                <div v-if="orderDetail.activityType == 7">
                    <div class="infoBox headBox" v-if="groupPurchase.status == 2">
                ...
                <div class="infoBox" v-if="orderDetail.express">
                  ...
                  <div class="colorblack number font12">
                    <input class="colorblack font12 inputText" v-if="showInput" type="text"
                           v-model="orderDetail.express.expressNo" v-show="orderShipOperate" @change="changeExpress()"/>
          ...
          <div class="dataGeneral backWhite padding20" v-if="fxjoperate">
            <div class="dataGenetalTitle">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.orderAfterSale = this.havePermissions('order:after:sale[shopId=1]')
      this.orderShipOperate = this.havePermissions('order:ship:operate[shopId=1]')
      this.fxjoperate = this.havePermissions('order:remark:operate[shopId=1]')
    },
    watch: {},
    mounted() {
      this.getorderDetail();
