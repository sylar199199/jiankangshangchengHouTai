      ...
      <div class="content">
        <div class="contanternews">
          ...
          <div class="dataGeneral backWhite padding20">
            ...
            <div class="orderInfo flex">
              <div class="infoLeft">
                ...
                <div class="infoBox">
                  <span class="colorGrey font12 marginright10">商户订单号</span>
                  <span class="colorblack font12">{{orderDetail.payNo}}</span>
                </div>
                <div class="infoBox">
                  <span class="colorGrey font12 marginright10">订单渠道</span>
                  <span class="colorblack font12" v-if="orderDetail.channelId == 1">昆仑健康APP</span>
                  <span class="colorblack font12" v-if="orderDetail.channelId == 2">昆仑微信公众号</span>
                </div>
              </div>
              <div class="infoRight" v-if="(orderDetail.payTime)">
                ...
                <img class="twoIcon " src="../../assets/images/twoIcon.png">
              </div>
              <div class="infoRight" v-if="!(orderDetail.payTime)">
                <div class="infoBox">
                  <span class="colorGrey font12 timeSpan">创建订单</span>
            ...
            <div class="orderInfo">
              <div class="infoLeft">
                ...
                <div class="infoBox" v-if="orderDetail.express">
                  ...
                  v-show="klorderShipOperate"  class="iconfont iconbianji marginLeft10 color2087 cursor" @click="showInput = true"></i>
                  <div class="colorblack number font12">
                    <input class="colorblack font12 inputText" v-if="showInput" type="text"
                           v-show="klorderShipOperate"  v-model="orderDetail.express.expressNo" @change="changeExpress()"/>
          ...
          <div class="dataGeneral backWhite padding20" v-if="orderDetail.afs">
            ...
            <div class="orderInfo flex">
              <div class="infoLeft">
                <div class="infoBox" v-show="klorderAfterSale">
          ...
          <div class="dataGeneral backWhite padding20"  v-show="kloperate">
            <div class="dataGenetalTitle">
  ...
  export default {
    ...
    data() {
      return {
        ...
        klorderAfterSale: false,
        klorderShipOperate: false,
        kloperate: false,
      };
    },
    created() {
      this.orderId = this.$route.query.id;
      this.klorderAfterSale = this.havePermissions('kl:order:after:sale[shopId=1]')
      this.klorderShipOperate = this.havePermissions('kl:order:operate[shopId=1]')
      this.kloperate = this.havePermissions('kl:order:remark:operate[shopId=1]')
    },
    watch: {},
    mounted() {
      this.getorderDetail();
