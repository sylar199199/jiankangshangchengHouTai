            ...
            <table v-if="noData" class="table" v-show="activityGoodsview">
              ...
              <tr v-for="(item,index) in tableData" :key="item.id" :index="index">
                ...
                <td>
                  ...
                  <span class="color2087 font12 cursor" @click="copyItem(item.id)" v-show="activityGoodsadd">复制</span>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.activityGoodsview = this.havePermissions("activityGoods:view[shopId=2]")
      this.activityGoodsadd = this.havePermissions("activityGoods:add[shopId=2]")
      this.activityGoodsupdate = this.havePermissions("activityGoods:update[shopId=2]")
      this.activityGoodsdelete = this.havePermissions("activityGoods:delete[shopId=2]")
      this.activityGoodsonShelf = this.havePermissions("activityGoods:onShelf[shopId=2]")
      this.activityGoodsoffShelf = this.havePermissions("activityGoods:offShelf[shopId=2]")
    ...
    methods: {
      ...
      addCommodity() {
        this.$router.push({name: 'addlzcommodity', params: {productId: 'addGoods'}})
      },
      goDetail(id) {
        this.$router.push({name: 'addlzcommodity', params: {productId: id}})
      },
