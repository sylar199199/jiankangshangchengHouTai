    ...
    <div class="contanternews">
        ...
        <div class="selectChannel backWhite padding20 baseInfo">
            ...
            <div class="editorBox flex" v-if="isDetail==1">
                ...
                <vue-ueditor-wrap v-model="goodsObj.faqs" :config="myConfig" @beforeInit="addCustomButtom" :key="1"></vue-ueditor-wrap>
            </div>
        </div>
                ...
                if(this.productId){
                    Service.fxjactivity().editorgoods(
                        ...
                        if(response.errorCode == 0){
                            Util.sessionStorageUtil.clear('fxjgoodsObj'+this.productId);
                            Util.sessionStorageUtil.clear('fxjspecs'+this.productId);
                            this.$message.success('操作成功');
                            this.$router.push({name: 'fxjcommodityList'})
                        }else{
                    ...
                    Service.fxjactivity().addgoods(
                        ...
                        if(response.errorCode == 0){
                            this.$emit('hasfinish', 'true')
                            Util.sessionStorageUtil.clear('fxjgoodsObj');
                            Util.sessionStorageUtil.clear('fxjspecs');
                            this.$message.success('操作成功');
                            this.$router.push({name: 'fxjcommodityList'})
